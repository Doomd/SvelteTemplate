...
<style>
  ...
  .color_mode_wrapper .switch:after {
    content: "";
    width: 46px;
    height: 46px;
    border-radius: 50%;
    ...
    animation: off 0.3s forwards cubic-bezier(0.8, 0.5, 0.2, 1.4);
  ...
  .color_mode_wrapper .switch:checked:after {
    animation: on 0.3s forwards cubic-bezier(0.8, 0.5, 0.2, 1.4);
    box-shadow: inset -5px -5px 4px rgba(53, 53, 53, 0.3);
  }
  ...
  .color_mode_wrapper .switch:checked:before {
    content: "";
    width: 15px;
    height: 15px;
    border-radius: 50%;
    ...
    filter: blur(0px);
    animation: sun 0.3s forwards ease;
  }
  ...
  .color_mode_wrapper .switch:before {
    content: "";
    width: 15px;
    height: 15px;
    border-radius: 50%;
    ...
    transform-origin: 53px 10px;
    animation: moon 0.3s forwards ease;
  }
  ...
  .color_mode_wrapper .switch:checked {
